...
{
	[Fact]
	public async Task Test_UnblockUserInThePlanUseCase_ParticipantSuccessfullyUnblocked_ShouldReturnSuccess()
	{
		// Arrange
		...
		Assert.Equal(Messages.ParticipantSuccessfullyUnblocked, result.GetMessage());
	...
	[Fact]
	public async Task Test_UnblockUserInThePlanUseCase_ParticipantIsAlreadyActiveInThePlan_ShouldReturnRejected()
	{
		// Arrange
		var useCase = _mocker.CreateInstance<UnblockUserInThePlanUseCase>();
		var command = new UnblockUserInThePlanCommand(
		...
		Assert.NotNull(result);
		Assert.True(result.IsRejected());
		Assert.Equal(Messages.ParticipantIsAlreadyActiveInThePlan, result.GetMessage());
	...
	public async Task Test_BlockUserInThePlanUseCase_UserCannotBeUnblockedInNotStartedPlan_ShouldReturnRejected()
	{
		...
		Assert.NotNull(result);
		Assert.True(result.IsRejected());
		Assert.Equal(Messages.ParticipantCanOnlyBeUnblockedInRunningPlans, result.GetMessage());
